...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-background-light gradient-bg">
            ...
            {/* Main Content */}
            <main className="lg:ml-72 p-6 lg:p-12 pb-24 relative">
                {/* Header */}
                    ...
                    <div className="bg-white rounded-xl p-8 lg:p-10 border-2 border-primary/20 shadow-xl shadow-primary/10 mb-12 relative overflow-hidden">
                        ...
                        <div className="relative flex flex-col lg:flex-row items-start lg:items-center gap-6">
                            ...
                            <button
                                ...
                                className="bg-background-dark hover:bg-background-dark/90 text-white px-8 py-4 rounded-xl font-bold transition-all flex items-center gap-2 shadow-xl font-display"
                            >
                                    ...
                                    <div key={escrow.id} className="bg-white p-7 rounded-xl border-2 border-gray-100 shadow-lg hover:shadow-xl hover:border-primary/30 transition-all group">
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <span className="px-4 py-2 bg-amber-50 text-amber-700 text-xs font-bold rounded-lg border-2 border-amber-200 shadow-sm">
                                                    FUNDING PENDING
                                                </span>
                                                <button
                                                    data-testid="fund-now-button"
                                                    onClick={() => router.push(`/trader/escrow/${escrow.id}/fund`)}
                                                    className="bg-primary hover:bg-primary/90 text-background-dark px-6 py-3 rounded-lg font-bold text-sm flex items-center gap-2 transition-all shadow-lg shadow-primary/30 group-hover:shadow-xl font-display"
                                                >
