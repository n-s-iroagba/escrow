...
export default function EditBankPage() {
    ...
    const { data: bank, loading: loadingBank } = useGet(API_ROUTES.BANKS.GET_ONE(id as string), {
        enabled: !!id
    });

    const { put, isPending, error } = usePut(API_ROUTES.BANKS.UPDATE(id as string), {
        onSuccess: () => {
    ...
    if (loadingBank) return <div className="p-8">Loading...</div>;
