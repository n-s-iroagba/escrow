...
export const initiateEscrow = asyncHandler(async (_req: Request, res: Response) => {
...
export const getEscrow = asyncHandler(async (_req: Request, res: Response) => {
    const { id } = req.params;
...
export const getUserEscrows = asyncHandler(async (_req: Request, res: Response) => {
...
export const getFundingDetails = asyncHandler(async (_req: Request, res: Response) => {
    const { id } = req.params;
...
export const markAsFunded = asyncHandler(async (_req: Request, res: Response) => {
    const { id } = req.params;
...
export const adminUpdateEscrow = asyncHandler(async (_req: Request, res: Response) => {
    const { id } = req.params;
